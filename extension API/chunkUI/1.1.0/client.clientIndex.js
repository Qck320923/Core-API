...
class ChunkUI {
    ...
    uiTools = {
        ...
        tree: {
            /**
             * @description 获取UiNode的子节点树（根节点的node属性为parent参数）
             * @param {UiBox|UiImage|UiInput|UiScale|UiText} parent 父UiNode
             */
            ...
            /**
             * @description 获取UiNode的子节点名称树（根节点的nodeName属性为parent参数的name属性）
             * @param {UiBox|UiImage|UiInput|UiScale|UiText} parent 父UiNode
             */
            getUiNodeNameTree(parent) {
                var childrenNameTree = [];
                for (var c of parent.children) {
                    childrenNameTree.push({
                        "nodeName": c.name,
        ...
        array: {
            /**
             * @description 获取UiNode的子节点数组（第一项为parent参数）
             * @param {UiBox|UiImage|UiInput|UiScale|UiText} parent 父UiNode
             */
            getUiNodeArray(parent) {
                var childrenArray = [parent];
                for (var c of parent.children) childrenArray = childrenArray.concat(this.getUiNodeArray(c));
                return childrenArray;
            },
            /**
             * @description 获取UiNode的子节点名称数组（第一项为parent参数的name属性）
             * @param {UiBox|UiImage|UiInput|UiScale|UiText} parent 父UiNode
             */
            getUiNodeNameArray(parent) {
                var childrenNameArray = [parent.name];
                for (var c of parent.children) childrenNameArray = childrenNameArray.concat(this.getUiNodeNameArray(c));
