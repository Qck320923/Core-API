...
class IridiumVoxels {
    ...
    rapidBuild = {
        ...
        perlinNoiseGenerateTerrain(sx, sz, ex, ez, options = { minHeight: 2, smooth: 2.5, waterLevel: 12, tree: false, quality: 1, k: 5, grass: "grass", dirt: "dirt", sand: "sand", water: "water" }) {
            if (!plutoniumFunctions) throw new Error("IridiumVoxels Error:Please add PlutoniumFunctions-API before calling the perlinNoiseGenerateTerrain method");
            else if (!carbonCoreBase) throw new Error("IridiumVoxels Error:Please add CarbonCoreBase before calling the perlinNoiseGenerateTerrain method");
            else if (carbonCoreBase.versions.compare(plutoniumFunctions.version, "1.0.0", function (x, y) { return x < y })) throw new Error("IridiumVoxels Error:The version of PlutoniumFunctions-API is not high enough");
