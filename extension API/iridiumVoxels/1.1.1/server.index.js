...
class IridiumVoxels {
    ...
    rapidBuild = {
        ...
        perlinNoiseGenerateTerrain(sx, sz, ex, ez, options = { minHeight: 2, smooth: 2.5, waterLevel: 12, tree: false, quality: 1, k: 5, grass: "grass", dirt: "dirt", sand: "sand", water: "water" }) {
            ...
            else if (carbonCoreBase.versions.compare(PlutoniumFunctions.version, "1.0.1", function (x, y) { return x < y })) throw new Error("IridiumVoxels Error:The version of PlutoniumFunctions-API is not high enough");
